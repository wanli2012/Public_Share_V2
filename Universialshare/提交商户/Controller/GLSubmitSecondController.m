...
//        return;
//    }
    if ([self.firstClassifyLabel.text isEqualToString:@"请选择一级行业分类"]) {
        [MBProgressHUD showError:@"还没有选择一级行业分类"];
        return;
    }
//    if ([self.secondClassifyLabel.text isEqualToString:@"请选择二级行业分类"]) {
//        [MBProgressHUD showError:@"还没有选择二级行业分类"];
//        return;
//    }

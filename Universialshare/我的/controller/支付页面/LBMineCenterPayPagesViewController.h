...
@property (nonatomic, assign) NSInteger payType; // 支付类型 1普通消费支付  2 米粉支付

@property (nonatomic, copy) NSString *order_id;//订单id

@property (nonatomic, copy) NSString *useableScore;//可用米粉
...
@property (nonatomic, assign)NSInteger pushIndex;//记录从哪个控制器push的 1:米粉商城确认订单  2:我的-订单

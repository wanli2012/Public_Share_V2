...
-(SDCycleScrollView*)cycleScrollView{
    ...
    if (!_cycleScrollView) {
        _cycleScrollView = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 0, self.bannerView.size.width, self.bannerView.size.height - 10)
                                                              delegate:self
